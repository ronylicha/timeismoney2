            ...
            <div class="payment-details">
                ...
                @if($invoice->stripe_payment_link && $invoice->status !== 'paid')
                    <div style="background-color: #f0f9ff; border: 2px solid #0ea5e9; border-radius: 8px; padding: 15px; margin-bottom: 20px; text-align: center;">
                        <div style="font-size: 16px; font-weight: bold; color: #0369a1; margin-bottom: 8px;">
                            💳 Payer cette facture en ligne
                        </div>
                        <div style="font-size: 12px; color: #0c4a6e; margin-bottom: 12px;">
                            Paiement sécurisé par carte bancaire
                        </div>
                        <div style="font-family: monospace; font-size: 10px; background-color: #ffffff; border: 1px dashed #0ea5e9; padding: 8px; border-radius: 4px; word-break: break-all; margin-bottom: 10px;">
                        ...
                        @php
                            try {
                                ...
                                echo '<div style="margin-top: 10px;"><img src="' . $qrCodeDataUri . '" alt="QR Code paiement" style="width: 100px; height: 100px; border: 1px solid #e2e8f0; border-radius: 4px;"></div>';
                            } catch (\Exception $e) {
